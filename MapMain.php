...
<body onLoad="showMessage( '<?php echo $_POST['message'];?>' );">
    ...
    <section>
        <div id="searchbox">
            ...
            <form name="formm" method="post">
                <input type="text" id="search" name="searchquery" value="<?php echo $_POST['searchquery'];?>" placeholder="지역, 식당, 음식 또는 태그">
    ...
    <section>
	   ...
	   if(isset($_POST['category'])) {
		$query = "SELECT * FROM Restaurants WHERE category = '$category' and name like '%".$keyword."%'";
	   } else {
